...
class ElectrodomesticoViewModel: ObservableObject {
    ...
    func fetchElectrodomesticosFromAPI(usuarioId: Int, token: String) async throws -> [Electrodomestico] {
        let urlString = "https://wattzonapi.onrender.com/api/wattzon/electrodomestico/usuario/\(usuarioId)"
    ...
    func createElectrodomestico(_ electrodomestico: Electrodomestico) async throws -> Electrodomestico {
        ...
        guard let url = URL(string: "https://wattzonapi.onrender.com/api/wattzon/electrodomestico") else {
            print("URL inválida")
            throw URLError(.badURL)
        }
    ...
    func updateElectrodomestico(_ electrodomestico: Electrodomestico) async throws {
        ...
        guard let url = URL(string: "https://wattzonapi.onrender.com/api/wattzon/electrodomestico/\(electrodomesticoId)") else {
            print("URL inválida")
            throw URLError(.badURL)
        }
